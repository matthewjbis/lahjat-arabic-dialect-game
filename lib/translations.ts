...
const en = {
  ...
  whyContributeTitle: "Why your clip matters",
  whyContribute1: "Your dialect is part of who you are — share the way your corner of the Arab world really sounds.",
  whyContribute2: "Help others train their ear and learn to recognize dialects they've never heard.",
  whyContribute3: "Every clip makes the game richer, more accurate, and more representative for everyone.",
  ...
  profileStatClips: "Clips contributed",
...
const ar: typeof en = {
  ...
  whyContributeTitle: "لماذا يهمّ مقطعك",
  whyContribute1: "لهجتك جزء من هويتك — شارِك الطريقة التي ينطق بها ركنك من العالم العربي حقاً.",
  whyContribute2: "ساعد الآخرين على تدريب أسماعهم وتعلّم تمييز لهجات لم يسمعوها من قبل.",
  whyContribute3: "كل مقطع يجعل اللعبة أغنى وأدقّ وأكثر تمثيلاً للجميع.",
  ...
  profileStatClips: "المقاطع المساهَم بها",
