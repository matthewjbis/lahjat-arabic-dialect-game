...
function AuthForm() {
  ...
  async function handleGoogle() {
    setError(null);
    setStatus("loading");
    // Supabase redirects back to /auth/callback, which exchanges the code for a
    // session and forwards to `next`. On failure the redirect never happens, so
  ...
  return (
    <div style={cardStyle}>
      ...
      {status === "done" ? (
        ...
        <>
          {/* Social sign-in — works for both sign in and create account */}
          <button
            type="button"
